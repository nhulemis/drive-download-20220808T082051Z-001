Shader "Custom/SphereFogAlpha"
{
	Properties
	{
		...
		SubShader
		{
			...
			#pragma surface surf Lambert finalcolor:finalcolor alpha vertex:vert
			...
			void finalcolor(Input IN, SurfaceOutput o, inout fixed4 color)
			{
				...
				color.rgb = color.rgb * step(lerpValue, 0.9);
				color.a = lerp(1, 0, lerpValue);
				#endif
			}
